...
RSpec.describe Thermostat, :type => :model do
  ...
  describe 'class' do
    it 'respond_to' do
      ...
      expect(thermostat).to respond_to(:check_status)
    end
  end
  #
  # describe '#new' do
  ...
  # end
  #
  describe '#check_status on manual mode' do
    before do
    ...
    it 'should be :off' do
      ...
      expect(thermostat.check_status).to eq(:off)
    end

    it 'should be :on' do
      thermostat.status = :on
      expect(thermostat.check_status).to eq(:on)
    end
